...
class Rectangle:
    """
        class Rectangle is a definition of a rectangle
        Attributes:
    ...
    def area(self):
        """
            Instance of public  method that calculates the area of rectangle
    ...
    def __str__(self):
        """
            return the rectangles string representation
        """
        rectangle = ""
        if self.__width is 0 or self.__height is 0:
            return rectangle
