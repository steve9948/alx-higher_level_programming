...
class Rectangle:
    """
        ...
        Attributes:
            ...
            number_of_instances (int): number of
                rectangle instances
            print_symbol: The representation of rectangle
    """
    ...
    def __init__(self, width=0, height=0):
        """
            initialises the rectangles` instances
            Args:
                width (int): The width of the rectangle
                height (int): The height of the rectangle
        """
    ...
    def area(self):
        """
            public method to calculate area of rectangle
    ...
    def __str__(self):
        """
            return rectangles string representation
        """
        rectangle = ""
        if self.__width is 0 or self.__height is 0:
            return rectangle
    ...
    def __repr__(self):
        """
            ...
            representation can be recreated into a new instance
            using eval
        """
        rectangle = ''
        if self.__width is 0 or self.__height is 0:
